...
module token_objects::aptos_token {
    ...
    #[test(creator = @0x123)]
    entry fun test_create_and_transfer(creator: &signer) acquires AptosToken {
    ...
    entry fun test_mint_soul_bound(creator: &signer) {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x50003, location = object)]
    entry fun test_frozen_transfer(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123)]
    entry fun test_unfrozen_transfer(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    entry fun test_noncreator_freeze(creator: &signer, another: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123, another = @0x456)]
    #[expected_failure(abort_code = 0x50002, location = Self)]
    entry fun test_noncreator_unfreeze(creator: &signer, another: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123)]
    entry fun test_set_description(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    entry fun test_set_immutable_description(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[expected_failure(abort_code = 0x50002, location = Self)]
    entry fun test_set_description_non_creator(
        creator: &signer,
        noncreator: &signer,
    ) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
    ...
    #[test(creator = @0x123)]
    entry fun test_set_name(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x50003, location = Self)]
    entry fun test_set_immutable_name(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123, noncreator = @0x456)]
    #[expected_failure(abort_code = 0x50002, location = Self)]
    entry fun test_set_name_non_creator(
        creator: &signer,
        noncreator: &signer,
    ) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
    ...
    #[test(creator = @0x123)]
    entry fun test_set_uri(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x50003, location = Self)]
    entry fun test_set_immutable_uri(creator: &signer) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
        let token_name = string::utf8(b"token name");
    ...
    #[test(creator = @0x123, noncreator = @0x456)]
    #[expected_failure(abort_code = 0x50002, location = Self)]
    entry fun test_set_uri_non_creator(
        creator: &signer,
        noncreator: &signer,
    ) acquires AptosToken {
        let collection_name = string::utf8(b"collection name");
    ...
    #[test_only]
    entry fun create_collection_helper(creator: &signer, collection_name: String) {
