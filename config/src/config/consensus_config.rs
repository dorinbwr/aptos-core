...
pub(crate) const MAX_SENDING_BLOCK_TXNS_QUORUM_STORE_OVERRIDE: u64 = 50000;
...
impl Default for ConsensusConfig {
    fn default() -> ConsensusConfig {
        ConsensusConfig {
            ...
            max_sending_block_bytes_quorum_store_override: 100 * 1024 * 1024, // 10MB
            max_receiving_block_txns: 10000,
            max_receiving_block_txns_quorum_store_override: 2
                * MAX_SENDING_BLOCK_TXNS_QUORUM_STORE_OVERRIDE,
            max_receiving_block_bytes: 3 * 1024 * 1024, // 3MB
            max_receiving_block_bytes_quorum_store_override: 100 * 1024 * 1024, // 15MB
